            ...
            <div className="row justify-content-between align-items-center">
                <div className='col-lg-6 mx-auto p-5 shadow-lg rounded-10'>
                    <div className="mx-auto">
                        <Link className="navbar-brand d-flex flex-column align-items-center justify-content-center" to="/home">
                            <img className="d-block" width="100" src={logo} alt="main logo" />
                            <p className="ms-1 fs-3 fw-bolder logo-f text-dark">woodpeckers</p>
                        </Link>
                    </div>
                    <div>
                        <form onSubmit={handleSignup}>
                            <div className='mb-2 mt-2'>
                                ...
                                <div className=''>
                                    <input className="form-control" type='text' name='name'
                                        id='name' onBlur={handleNameChange} required />
                                </div>
                            </div>
                            <div className='mb-2 mt-2'>
                            ...
                            <div className="form-check my-2">
                                <input className="form-check-input bg-dark" type="checkbox" id="gridCheck" required />
                                <label className="form-check-label" htmlFor="gridCheck">
                                    Agree to woodpeckers's terms and conditions
                                </label>
                            </div>
                        ...
                        <p className='mt-4'>
                            ...
                            <Link className="d-block btn btn-outline-dark" to="/signin" >Log In</Link>
                        </p>
