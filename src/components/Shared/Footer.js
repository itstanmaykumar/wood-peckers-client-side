                ...
                <div className="py-4 row justify-content-between text-start">
                    ...
                    <div className="mt-4 mb-3 text-white col-lg-4 col-sm-6 order-lg-3 order-xs-1">
                        ...
                        <div className="row justify-content-between">
                            <form onSubmit={handleNewsletter} className="input-group">
                                ...
                                <button className="btn btn-outline-main" type="submit" id="button-addon2">Subscribe</button>
                            </form>
                        </div>
                    </div>
                    <div className="mt-4 col-lg-4 col-sm-12 order-lg-1 order-xs-3">
                        ...
                        <small className="text-second d-block"><span className="text-white">Woodpeckers, Inc.</span> provides great deals on our huge selection of posters & prints, with fast shipping, free returns, and custom framing options you'll love!</small>
