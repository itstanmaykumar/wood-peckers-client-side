...
const Newsletter = () => {
    ...
    const handleNewsletter = (e) => {
        ...
        const resolveAfter1Sec = new Promise(resolve => setTimeout(resolve, 1500));
        toast.promise(
            resolveAfter1Sec,
            {
            ...
            <div className="row justify-content-between align-items-center">
                ...
                <div className="col-lg-6 ps-5">
                    ...
                    <form onSubmit={handleNewsletter} className='col-10'>
                        <input type="email" name="email" className="form-control" placeholder="Your Email Address" defaultValue={user.email} aria-label="Email Address" disabled={user.email} required />
                        <div className="form-check my-2">
                            <input className="form-check-input bg-dark" type="checkbox" id="gridCheck" defaultChecked name="alert" required />
                            <label className="form-check-label" htmlFor="gridCheck">
                                Get Offers & Discount Alerts
                            </label>
                        </div>
                        <button className='mt-3 btn btn-main' type='submit' name="bttn" >Subscribe Now</button>
                    </form>
                </div>
            </div>
        </div>
